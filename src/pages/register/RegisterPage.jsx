...
if(value!==password)
{
  ...
  placeholder='Confirm password' className={`placeholder:text-[#959ead] text-dark-hard mt-3 rounded-lg px-5 py-4 font-semibold block outline-none border border-[#c3cad9] ${errors.confirmPassword ? "border-red-500": "border-[#c3cad9]"}`}/>
  {errors.confirmPassword?.message&&(
    <p className={`text-red-500 mb-6 w-full `}>{errors.confirmPassword?.message}</p>
)}
    </div>
