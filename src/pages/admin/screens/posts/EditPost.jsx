...
import { getAllPosts, getSinglePost, updatePost } from '../../../../services/index/posts';
...
const {mutate: mutateUpdatePostetails, isLoading: isLoadingUpdatePostDetails } =useMutation({
...
updatedData.append("postPicture", picture)
    ...
    mutateUpdatePostetails({updatedData, slug, token: userState.userInfo.token })
}
...
<HiOutlineCamera className='w-7 h-auto text-primary'/>
        ...
        <button type='button' onClick={handleDeleteImage} className='w-fit bg-red-500 text-white text-sm font-semibold rounded-lg px-2 py-1 mt-5'>Delete Image</button>
    ...
    <button disabled={isLoadingUpdatePostDetails} type='button' onClick={handleUpdatePost} className='w-full bg-green-500 text-white font-semibold rounded-lg px-4 py-2 disabled:cursor-not-allowed disabled:opacity-70'>Update</button>
