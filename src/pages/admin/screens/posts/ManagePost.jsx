...
const ManagePost = () => {
    ...
    const {data: postsData, isLoading, isFetching, refetch} = useQuery({
        ...
        const { mutate: mutateDeletePost, isLoading: isLoadindDeletePost } = useMutation({
            ...
            onSuccess: (data) => {
              ...
              toast.success("Poast is deleted");
            },
            onError: (error) => {
...
<tr>
                                ...
                                <td className="px-5 py-5 text-sm bg-white border-b border-gray-200">
                                    <p className="text-gray-900 whitespace-no-wrap">
                                        {post.categories.length>0 ? post.categories[0] : "uncategoriesed"}
                                    </p>
                                </td>
                                <td className="px-5 py-5 text-sm bg-white border-b border-gray-200">
                                    <p className="text-gray-900 whitespace-no-wrap">
...
{post.tags.length>0? post.tags.map((tag,index)=>(
    <p>{tag}{post.tags.length-1!==index && "," }</p>)
                                ...
                                <td className="px-5 py-5 text-sm bg-white border-b border-gray-200 space-x-5">
                                    ...
                                    }} disabled={isLoadindDeletePost} type='button' className='text-red-600 hover:text-red-900 disabled:opacity-70 disabled:cursor-not-allowed'>Delete</button>
