...
, a diary of tears and past.  </h1>
<p className='text-dark-light mt-4 text-center lg:text-base xl:text-xl  md:text-xl lg:text-left'> Welcome to <span>Feelings to words</span>, your digital haven of inspiration and insight. Dive into our engaging narratives, explore diverse perspectives, and embark on thought-provoking journeys. Join our community where words weave wonders and curiosity knows no bounds.</p>
