...
<h2 className='font-roboto font-meduim text-dark-hard mt-8 md:text-xl'>Tags</h2>
{tags.length ===0 ? <p className='text-slate-500 text-xs mt-2 '>There is no tags for this post</p>: (
